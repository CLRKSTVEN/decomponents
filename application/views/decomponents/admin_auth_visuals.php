                ...
                <div class="container-fluid">
                    <div class="row mb-3 align-items-center">
                        <div class="col">
                            ...
                            <p class="text-muted mb-0">Customize login/signup hero copy and imagery.</p>
                        </div>
                        <div class="col-auto">
                            <a href="<?= site_url('Decomponents/auth_visuals'); ?>" class="btn btn-light"><i class="bi bi-x-lg"></i> Clear Edit</a>
                        </div>
                    </div>
